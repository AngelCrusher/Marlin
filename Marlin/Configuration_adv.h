...
#define PWM_MOTOR_CURRENT { 1200, 1200, 700 }          // nh shortstep Values in milliamps
...
#define ADVANCED_PAUSE_FEATURE
  ...
  #define PAUSE_PARK_RETRACT_LENGTH            1  // nh (mm) Initial retract.
                                                  // This short retract is done immediately, before parking the nozzle.
  #define FILAMENT_CHANGE_UNLOAD_FEEDRATE     10  // (mm/s) Unload filament feedrate. This can be pretty fast.
  #define FILAMENT_CHANGE_UNLOAD_ACCEL        25  // (mm/s^2) Lower acceleration may allow a faster feedrate.
  #define FILAMENT_CHANGE_UNLOAD_LENGTH      300  // nh (mm) The length of filament for a complete unload.
  ...
  #define FILAMENT_UNLOAD_RETRACT_LENGTH      2  // nh (mm) Unload initial retract length.
